...
Revision ID: 6930eee816a3
Revises: 
Create Date: 2024-09-30 15:27:56.196128
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_fishspecies_species'), 'fishspecies', ['species'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_fishspecies_species'), table_name='fishspecies')
